...
ICON_WARNING = "../../resources/AlertCautionIcon.icns"
...
SEARCH_AS = 'tell application id "com.runningwithcrayons.Alfred" to search "{query}"'
...
def intvar(name, default=0):
    ...
    if v is not None:
        try:
            ...
            return default
        return v
    log.debug(f'no value set for workflow variable "{name}"\nusing default: {default}')
    return default
